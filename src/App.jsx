      ...
      <nav className="md:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 z-10">
        <div className="flex justify-around items-center p-2">
          {userRole === 'student' ? (
            ...
            <>
              <a onClick={() => setActiveTab('classes')} className={`flex flex-col items-center p-2 cursor-pointer ${activeTab === 'classes' ? 'text-primary-600' : 'text-gray-500'}`}>
              ...
              <a onClick={() => setActiveTab('joinRequests')} className={`flex flex-col items-center p-2 cursor-pointer ${activeTab === 'joinRequests' ? 'text-primary-600' : 'text-gray-500'}`}>
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="mb-1"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><line x1="19" y1="8" x2="19" y2="14"/><line x1="22" y1="11" x2="16" y2="11"/></svg>
